# Certified Truth Record: Minimum Kernel Footing v0.1

## Certification Boundary

The following are certified as **Minimum Kernel Footing v0.1**:
...
- Control documents:
  ...
  - `docs/hostile-audit-report-v0.1.md`
...
- **Tests**: 24 unit tests pass (`cargo test`)
...
- **Hostile audit report**: `docs/hostile-audit-report-v0.1.md` found no blockers.
...
3. This certification applies only to the minimum kernel footing v0.1, not to future expansion.
...
The kernel is certified as **Minimum Kernel Footing v0.1** within the above boundary only.
