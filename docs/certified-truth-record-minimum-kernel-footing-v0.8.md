# Certified Truth Record: Minimum Kernel Footing v0.8

## Certification Boundary

The following are certified as **Minimum Kernel Footing v0.8**:
...
- Control documents:
  ...
  - `docs/hostile-audit-report-v0.8.md`
...
- **Hostile audit report**: `docs/hostile-audit-report-v0.8.md` found no blockers.
...
5. This certification applies only to the minimum kernel footing v0.8, not to future expansion.
...
The kernel is certified as **Minimum Kernel Footing v0.8** within the above boundary only.
